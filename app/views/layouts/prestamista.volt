...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="#"><i class="app-menu__icon fa fa-search-plus"></i><span class="app-menu__label">Busqueda Avanzada</span></a></li>
        <li><a class="app-menu__item" href="/"><i class="app-menu__icon fa fa-book"></i><span class="app-menu__label">Mis Prestamos</span></a></li>
