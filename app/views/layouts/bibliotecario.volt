...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="/lector"><i class="app-menu__icon fa fa-user-plus"></i><span class="app-menu__label">Gestionar Usuarios</span></a></li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-table"></i><span class="app-menu__label">Gestion de prestamos</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="/reserva"><i class="icon fa fa-circle-o"></i>Reservados</a></li>
            <li><a class="treeview-item" href="/prestamo" ><i class="icon fa fa-circle-o"></i>Prestados</a></li>
          </ul>
        </li>
