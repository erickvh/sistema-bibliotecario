...
CREATE TABLE users_roles(
    ...
    CONSTRAINT fk_users_roles_users FOREIGN KEY (idUser) 
    REFERENCES users(id) ON UPDATE RESTRICT ON DELETE RESTRICT,
    
    CONSTRAINT fk_users_roles_roles FOREIGN KEY (idRol) 
...
CREATE TABLE subcategorias(
    ...
    CONSTRAINT fk_subcategorias_materiales FOREIGN KEY (idCategoria)
    REFERENCES materialesBibliograficos(id) ON UPDATE RESTRICT ON DELETE RESTRICT
...
CREATE TABLE autores(
    ...
    CONSTRAINT fk_autores_material FOREIGN KEY (idMaterial)
    REFERENCES materialesBibliograficos(id) ON UPDATE RESTRICT ON DELETE RESTRICT
);